 ...
 */function IconButton(_ref){let{icon,onClick,ariaLabel}=_ref;// Handles the click event on the IconButton.
const handleClick=event=>{onClick(event)};return/*#__PURE__*/_react.default.createElement("div",{onClick:handleClick,className:"IconButton",role:"button","aria-label":ariaLabel},/*#__PURE__*/_react.default.createElement(_reactFontawesome.FontAwesomeIcon,{icon:icon,className:"IconButton__button"}))}