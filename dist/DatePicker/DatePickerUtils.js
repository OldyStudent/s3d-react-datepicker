 ...
 * @returns {void}
 */function updateDatePickerContainerPosition(inputElement,datePickerContainer){const rectA=inputElement.getBoundingClientRect();datePickerContainer.style.top=rectA.top+rectA.height+3+"px";datePickerContainer.style.left=rectA.left-3+"px"}